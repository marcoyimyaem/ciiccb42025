...
public class LambdaLesson {
    ...
    public static void main(String[] args) {
        ...
        consumer1.accept("Hello Java batch 4");
        Supplier<Integer> supplier1 = ()->21; 
        Supplier<Integer> supplier2 = ()-> new Random().nextInt(100);
        consumer1.accept(supplier1.get().toString());
        consumer1.accept(supplier2.get().toString());
        Comparator<Integer> ints = (a,b)->a-b;
        System.out.println(ints.compare(21, 100));
